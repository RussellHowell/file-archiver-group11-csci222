#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/file-archiver-group11-csci222
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Oct 6 21:22:05 2015
...
QMAKE_TARGET  = file-archiver-group11-csci222
DESTDIR       = dist/Debug/GNU-Linux-x86/
TARGET        = dist/Debug/GNU-Linux-x86/file-archiver-group11-csci222
...
dist: 
	@$(CHK_DIR_EXISTS) build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0 || $(MKDIR) build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0/ && $(COPY_FILE) --parents Archiver.h FileArchiver.h FileRec.h GetComment.h Retriever.h VersionRec.h ui_Archiver.h ui_GetComment.h ui_Retriever.h build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0/ && $(COPY_FILE) --parents Archiver.cpp FileArchiver.cpp FileRec.cpp GetComment.cpp Retriever.cpp VersionRec.cpp main.cpp build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0/ && $(COPY_FILE) --parents Archiver.ui GetComment.ui Retriever.ui build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0` && $(TAR) file-archiver-group11-csci2221.0.0.tar file-archiver-group11-csci2221.0.0 && $(COMPRESS) file-archiver-group11-csci2221.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0`/file-archiver-group11-csci2221.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/file-archiver-group11-csci2221.0.0
