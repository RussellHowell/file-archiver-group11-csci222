...
static const char qt_meta_stringdata_retriever[] = {
    "retriever\0\0on_selectfile_clicked()\0"
...
const QMetaObjectExtraData retriever::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject retriever::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_retriever,
      qt_meta_data_retriever, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &retriever::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_retriever))
